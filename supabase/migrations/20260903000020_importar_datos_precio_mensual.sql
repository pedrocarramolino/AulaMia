-- AulaMia · la restauración de copias sigue al renombrado `precio_hora` → `precio_mensual`
--
-- `app.importar_datos` insertaba `precio_hora`, columna que dejó de existir en
-- `20260903000017_precio_mensual.sql`: sin esto, importar una copia falla.
...
begin
  ...
  insert into alumno (id, user_id, nombre, apellidos, fecha_nacimiento, curso, nivel,
    observaciones, color, precio_mensual, prioridad, activo, creado_en, actualizado_en)
  select r.id, u, r.nombre, r.apellidos, r.fecha_nacimiento, r.curso, r.nivel,
    r.observaciones, r.color, r.precio_mensual, r.prioridad, r.activo, r.creado_en, r.actualizado_en
